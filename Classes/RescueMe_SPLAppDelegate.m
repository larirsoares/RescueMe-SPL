...
#import "RescueMe_SPLAppDelegate.h"
#import "RescueMe_SPLViewController.h"
#import "ContactViewController.h"
#import "SettingsViewController.h"

@implementation RescueMe_SPLAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    RescueMe_SPLViewController *homeViewController = [[RescueMe_SPLViewController alloc] initWithNibName:@"RescueMe_SPLViewController" bundle:nil];
    ...
    self.rootController.viewControllers = [NSArray arrayWithObjects:homeViewController, contactNavigationController, settingsNavigationController, nil];
